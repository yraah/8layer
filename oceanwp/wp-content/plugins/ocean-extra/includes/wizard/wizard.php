    ...
    class Ocean_Extra_Theme_Wizard {
        ...
        public function ocean_ready_setup() {
            ...
            <div class="owp-ready-wrap owp-wrap">
                ...
                <p><?php
            echo
            sprintf(__('The first part of creating your website is now done. There&rsquo;s still some work to be done, though. As promised, we&rsquo;ve created a %1$sbonus introduction video series%2$s, that&rsquo;ll get you up to speed in no time. It&rsquo;s highly recommended to watch it.', 'ocean-extra'), '<strong>', '</strong>'
            );
            ?></p>
